...
INSERT INTO AdminStaff (staff_name, staff_phone, station_id, staff_is_active) VALUES
    ('홍길동', '010-6789-0123', 1,    1),  -- 시흥시청 대여소 운영요원
...
--    m1 : bike#3 수리 의뢰 진행중 (incident i1 연계)
--    m2 : bike#6 정기점검 완료
-- -----------------------------------------------
INSERT INTO Maintenance (bicycle_id, incident_id, maintenance_type, description, started_at, ended_at, maintenance_status) VALUES
    (3, 1,    '수리',     '앞 브레이크 패드 및 케이블 교체', '2026-05-10 15:00:00', NULL,                  '진행중'),
    (6, NULL, '정기점검', '2인용 자전거 30일 정기점검',       '2026-05-08 10:00:00', '2026-05-08 11:30:00', '완료');
...
--    al1 : bike#1 → 시흥시청 대여소 (박관리 지시)
--    al2 : bike#10 → 능곡근린공원 대여소 (박관리 지시)
-- -----------------------------------------------
